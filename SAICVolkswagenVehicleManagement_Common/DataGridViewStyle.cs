...
namespace SAICVolkswagenVehicleManagement_Common
{
    public static class DataGridViewStyle
    {
        ...
        public static void DgvStyle3(DataGridView dgv)
        {
            ...
            //显示数据时的背景色
            dgv.RowsDefaultCellStyle.BackColor = System.Drawing.Color.DeepSkyBlue;
            //数据网格颜色
            dgv.GridColor = System.Drawing.Color.DarkGray;
            //列标题的边框样式
            ...
            {
                dgv.Columns[i].DefaultCellStyle.ForeColor = System.Drawing.Color.White;
            }
        }
